    ...
    <style type="text/css">
		...
		*/
		...
		header span#sbasket{
			position:relative;
		    top: 4.2em;
		    background-color:#e14ea;/*hsl(205, 100%, 50%);*/
			width: 8.1em;
			margin-left:86.5%;
			border-radius :10px;
			z-index: 9500
		...
		div#divRechercher form fieldset {
			position: relative;
			padding:0.12%;
			margin: auto;
		...
		div#divRechercher form fieldset legend {
			font-size:16pt;
			font-weight: bold;
			color: navy;
			width: 35%;
		...
		div#divRechercher form fieldset p#pannonce {
			font-size:14.5pt;
			font-weight: bold;
			padding:0.4%;
			color: blue;
		...
		div#divRechercher form fieldset label{
			font-size:13pt;
			float: left;
			width: 28%;
			padding:0.5%;
		...
		div#divRechercher form fieldset input{
			/*clear:left;*/
			font-size:13pt;
			width:49.75%;
			padding:0.5%;
		...
		div#divRechercher form fieldset button#RechercherPA{
		...
		div#divRechercher form fieldset a#aRechercheAvancee {
			position:relative;
			margin-left:82%;
			margin-bottom:.25%;
			margin-top:.5%;
		...
		div#divRechercher form fieldset span.requis{
				color: #c00;
				margin: 0% 0% 0% 0%;
		}
					
					
		div#divRechercher form fieldset span.erreur{
			font-size:10.5pt;
						 
		}
					
		div#divRechercher form fieldset p.erreur{
			font-family:"tunga";
			font-size:15pt;
			font-weight:bold;
			text-align:center;
		...
		div#divRechercher form fieldset p.succes{
			font-family:"tunga";
			font-size:15pt;
			font-weight:bold;
			text-align:center;
		...
		div#divRechercher form fieldset p#pinfo{
			margin-left: auto;
			margin-right: auto;
			font-size:13.5pt;
			font-weight: bold;
    ...
    <div id="container">
        <header>
            ...
            <div id="divRechercher">
                <form action="<spring:url value="/searchresultpost" />" method="post">
                    <fieldset>
                        ...
                        <button type="submit" id="RechercherPA" name="RechercherPA" class="bouton">Search</button>
        ...
        <footer>
            <p>
                Copyright &copy; 2016, <a href="mail:juoud1@gmail.com">telus santé</a>, GNU Licence
            </p>
        </footer>
    </div>
</body>
