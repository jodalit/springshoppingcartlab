            ...
            <div id="divimagepcple" class="divmain">
            	...
            	<form action="${updateItem}" method="POST">
                    ...
                    <fieldset>
                        ...
                        <input type="datetime" id="itemExpireDate" name="itemExpireDate" size="20" maxlength="20" size="20" tabindex="3" value="${item.expireDate}" /><span id="itemExpireDatespan"></span><br />
                    </fieldset>
